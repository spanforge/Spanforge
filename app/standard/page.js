...
const NAMESPACES = [
  ...
  { key: 'consent.*',         desc: 'Consent recording and verification events — data-use consent, withdrawal, and scope checks.' },
  { key: 'hitl.*',            desc: 'Human-in-the-loop review events — approval requests, outcomes, and escalation records.' },
  ...
  { key: 'llm.audit.*',       desc: 'HMAC audit chain events — key rotation, chain verification, and tamper detection records.' },
        ...
        <div className="container">
          <div className={styles.sectionInner}>
            ...
            <p className={styles.sectionBody}>
              Agentic AI systems produce compliance evidence that is fundamentally different
              ...
              steps — each with its own cost, latency, and regulatory risk profile.
            </p>
            <p className={styles.sectionBody}>
              Yet today there is no broadly adopted cross-vendor standard for what an
              &ldquo;AI compliance event&rdquo; looks like: what fields it carries,
            ...
            <p className={styles.sectionBody}>
              RFC-0001 SPANFORGE fills this gap. It is an open specification for compliance
              and governance of agentic AI systems, designed for incremental adoption and
              vendor-neutral integration across every AI framework and observability backend.
            </p>
          </div>
        </div>
      </section>
    ...
    tags=["prod", "summarisation"],
      ...
      <section className={styles.sectionCharcoal}>
        <div className="container">
          ...
          <h2 className={styles.sectionH2}>15 compliance & governance namespaces.</h2>
          <p className={styles.sectionBody} style={{ maxWidth: '700px' }}>
            RFC-0001 SPANFORGE defines 15 namespaces across two categories: five compliance &
            governance namespaces (consent, hitl, model_registry, explanation, audit) and ten
            instrumentation & telemetry namespaces. Every event type is dot-separated, typed,
            and has a versioned JSON Schema payload definition.
          </p>
        ...
        <div className="container">
          <div className={styles.sectionInner}>
            ...
            <p className={styles.sectionBody}>
              ...
              <code className={styles.inlineCode}>spanforge audit-chain events.jsonl</code>.
            </p>
            <div className={styles.codeBlock}>
              <div className={styles.codeBlockHeader}>
              ...
              <table className={styles.table}>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>Full 15-namespace taxonomy, HMAC chains, PII redaction, governance primitives.</td>
                  </tr>
                </tbody>
              </table>
            </div>
      ...
      <section className={styles.ctaSection}>
        <div className="container">
          ...
          <p className={styles.ctaSub}>
            ...
            pip-installable, covers all 15 namespaces.
          </p>
