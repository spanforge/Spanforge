export const phases = [
  ...
  },
  {
    ...
    gate: 'Nothing ships without all CI/CD gates passing — security, quality, behaviour, performance, and governance checks all green.',
  },
  {
    num: '04',
    id: 'govern',
...
export const trustDimensions = [
  { letter: 'T', word: 'Traceability',   desc: 'Every agent action must be traceable. Full audit trail. No black boxes.' },
  { letter: 'R', word: 'Responsibility', desc: 'A named human is accountable for every AI system.' },
  { letter: 'U', word: 'User Rights',    desc: 'Consent, transparency, and recourse for every individual AI affects.' },
  { letter: 'S', word: 'Safety Guardrails', desc: 'Technical constraints embedded in architecture, not just policy.' },
  { letter: 'T', word: 'Transparency',   desc: 'Customers, regulators, and employees understand how AI affects them.' },
]
